...
const required = [
  ...
  'docs/QA_EXECUTION_EVIDENCE.md', 'docs/CAPABILITY_VERIFICATION_MATRIX.md', 'docs/ENTERPRISE_READINESS.md',
  'docs/FINAL_COMPLETION_AUDIT.md', 'docs/MASTER_GAP_AUDIT.md', 'docs/CODEX_COMPLETION_LOOP_MEGAPROMPT.md',
  'docs/OPERATIONS_RUNBOOK.md', 'docs/FIRST_PLACE_FINISHER.md', 'docs/LIVE_COLLABORATION_ARCHITECTURE.md',
...
add('qa_evidence_command', pkg.scripts?.['qa:report'] === 'node scripts/collect-qa-evidence.mjs' ? 'PASS' : 'FAIL', 'External QA evidence command is available.', ['package.json', 'scripts/collect-qa-evidence.mjs']);
...
const helperControls = [helperPlan.includes('VALIDAR_EXOVIA.bat'), helperPlan.includes('System Check'), helperPlan.includes('Live room'), helperPlan.includes('prueba offline'), helperPlan.includes('QA_MARCE_GASTON')];
