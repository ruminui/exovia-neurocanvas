...
add('reproducible_install_lock', hasLock ? 'PASS' : 'BLOCKED', hasLock ? 'Root package lock is present.' : 'package-lock.json must be generated by a trusted Node 20 npm install; do not hand-author it.', ['package-lock.json']);
