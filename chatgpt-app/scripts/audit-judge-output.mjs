...
assert(exo.manifest?.thirdPartyCodeIncluded === false, "EXO pack does not disclose its third-party code boundary");
...
console.log(`Judge artifact audit passed: ${files.length} files, no sensitive demo values, source-linked EXO pack, evidence-bounded winner and valid SHA-256 fingerprints.`);
